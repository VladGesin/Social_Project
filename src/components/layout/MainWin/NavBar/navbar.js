...
const navbar = () => {
	return (
		<Navbar collapseOnSelect expand="lg" bg="light" variant="light" dir="rtl" className="mb-2">
			...
			<Navbar.Collapse id="responsive-navbar-nav">
				<Nav className="m-auto links-container">
					...
					<NavDropdown title="Xpertesy" id="collasible-nav-dropdown" dir="rtl" className="text-right">
						{XpertesyItems.link.map((item) => <NavMapLinks link={item} key={item.name} />)}
					</NavDropdown>
